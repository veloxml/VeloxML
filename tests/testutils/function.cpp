...
double f1_score(std::vector<std::vector<double>> &y_true, std::vector<std::vector<double>> &y_pred)
{
  ...
  double precision = (true_positive + false_positive) == 0 ? 0.0 : static_cast<double>(true_positive) / (true_positive + false_positive);
  double recall = (true_positive + false_negative) == 0 ? 0.0 : static_cast<double>(true_positive) / (true_positive + false_negative);
